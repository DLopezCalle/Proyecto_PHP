...
<html lang="es">
    ...
    <body>
        ...
        <form enctype="multipart/form-data" action="anadirarticulo.php" method="post">
            <ul>
                ...
                <li>                                             
                    ...
                    <input type="text" name="nombre" placeholder="" value="" pattern="[A-Za-z]{,}" title="Introduzca su nombre de usuario" autocomplete="off" autofocus required/>
                </li>
                </fieldset>
                <fieldset>
                ...
                <li>
                    ...
                    <input class="inferior" name="imagen" type="file" placeholder="" value="" title="Inserte la imagen del artículo" required/><br/><br/>
                </li> 
                </fieldset> 
                <fieldset>
                ...
                <li>
                    ...
                    <input type="number" placeholder="" value="" title="Inserte el precio de compra" name="preciocompra" required/><br/><br/>
                </li>
                </fieldset>
                <fieldset>
                ...
                <li>
                    ...
                    <input type="number" placeholder="" value="" title="Inserte el precio de venta" name="precioventa" required/><br/><br/>
                </li>
                </fieldset>
                <fieldset>
                ...
                <li>
                    ...
                    <input type="text" placeholder="" value="" title="Inserte descripción" name="descripcion" required/><br/><br/>
                </li>
                </fieldset>
                <fieldset>
                ...
                <li>
                    ...
                    <input type="number" placeholder="" value="" title="Inserte el stock actual" name="stock" required/><br/><br/>
                </li>
                </fieldset>
